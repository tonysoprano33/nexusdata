"""
Servicio de chat con dataset usando Groq
...
def chat_with_dataset(question: str, dataset_summary: Dict[str, Any], sample_data: List[Dict] = None) -> str:   
    """
    Responde preguntas sobre el dataset usando Groq y contexto de los datos
    """
    api_key = os.environ.get("GROQ_API_KEY")
    if not api_key:
        return "🔑 Servicio de chat no disponible. Configure GROQ_API_KEY."
...
"""
    ...
    try:
        completion = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Eres un asistente de análisis de datos profesional."},
        ...
        return f"⚠️ Error en el chat con Groq: {str(e)[:100]}"
