...
def _fallback_chart_recommendations(data_stats: dict) -> List[Dict[str, Any]]:
    """Fallback inteligente cuando Groq falla."""
...
"""
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Eres un experto en BI y visualización de datos. Responde solo con JSON válido."},
...
def prepare_chart_data(df: pd.DataFrame, recommendation: Dict[str, Any]) -> Dict[str, Any] | None:
    """Versión limpia y robusta de prepare_chart_data."""
    try:
